...
public class MST_Auth_ClientWrapper extends MST_Auth_BaseClientWrapper{
	...
	public MST_Auth_ClientWrapper(MST_Auth_Utils parmMSTAUtils, int parmMSTA_CONNECTION_TIMEOUT, int parmMSTA_RESPONSE_TIMEOUT, int parmMSTA_TIMEOUT_WAIT,  int parmMSTA_TRIES) {
	...
	public void SetMicroservice(String microservicename) throws MSTAException {
	    ...
	    //System.out.println(MSTAUtils.MyMicroserviceName + " To: " + OutboundService + " URI: "+ MSTAUtils.GraphUID);
	...
	private void SendHeader() throws MSTAException {
		...
		mstauthbuilder = HttpRequest.newBuilder();
		//logobject
		//String jsonquery = "INSERT INTO mstauth.service_tree JSON '" + logobject.toString() +"'";
      ...
      if (mode.equals("ASYNCH")) {
    	  MST_Auth_SendThread T1 = new MST_Auth_SendThread(MSTAUtils, MSTA_CONNECTION_TIMEOUT, MSTA_RESPONSE_TIMEOUT, MSTA_TIMEOUT_WAIT, MSTA_TRIES, mstauthbuilder);
